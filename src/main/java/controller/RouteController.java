...
public class RouteController {
    ...
    public String showEditUserForm(@PathVariable UUID userId) {
        ...
        return "<html><body>" +
                ...
                "Budget: <input type='number' name='budget' step='0.01' value='" + user.getBudget() + "' required><br><br>" +
    ...
    public String budgetManagement(@PathVariable UUID userId) {
        ...
        return "<html><body>" +
                ...
                "<p><strong>Total Budget:</strong> $" + String.format("%.2f", user.getBudget()) + "</p>" +
                ...
                "New Budget: <input type='number' name='budget' step='0.01' value='" + user.getBudget() + "' required><br><br>" +
    ...
    public ResponseEntity<String> updateBudget(
        ...
        String html = "<html><body>" +
                ...
                "<p><strong>New Budget:</strong> $" + String.format("%.2f", budget) + "</p>" +
                "</body></html>";
    ...
    public String weeklySummary(@PathVariable UUID userId) {
        ...
        if (weeklyTransactions.isEmpty()) {
            ...
            transactionsHtml.append("<table border='1' style='border-collapse: collapse; width: 100%;'>");
            transactionsHtml.append("<tr><th>Description</th><th>Amount</th><th>Category</th><th>Date</th></tr>");
        ...
        return "<html><body>" +
                ...
                "<p><strong>Total Spent Last 7 Days:</strong> $" + String.format("%.2f", weeklyTotal) + "</p>" +
